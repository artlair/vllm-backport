...
class KVCacheCoordinator(ABC):
    ...
    def __init__(
        ...
        # The EAGLE drop is taken by the eagle groups but lands the whole hit, so
        # every Mamba group checkpoints where that drop resumes, eagle or not.
    ...
    def get_replay_boundaries(self, request: Request) -> tuple[int, ...]:
        ...
        at each position, whether or not it is a group that drops; EAGLE groups
