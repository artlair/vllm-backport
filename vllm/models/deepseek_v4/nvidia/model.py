...
class DeepseekV4MoE(nn.Module):
    def __init__(
        ...
        *,
        ...
        # at the caller-supplied image_sentinel_lo; 0 disables vision routing
        # (text model). Our DeepSeek V4 tree has no vision path, so the default
        # is 0 and V4.1 passes its own IMAGE_SENTINEL_BASE_ID explicitly.
