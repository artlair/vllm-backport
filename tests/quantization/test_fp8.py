...
def test_deepseek_v41_mxfp8_scale_loading(
    ...
    try:
        ...
        # TODO(dsv41): the generic ModelOptLinearMethod landed upstream after
        # our base; native MXFP8 linear loading is not ported (see modelopt.py).
        pytest.skip("ModelOptLinearMethod is not available on this base")
